...
@app.route('/')
def index():
    return render_template('index.html', video_path=None, emotions=None)
...
def upload_video():
    ...
    if video_file:
        ...
        emotions_detected,path = detect_emotions(video_path)
        print(emotions_detected)
        print('path',path)
        
        return render_template('index.html', video_path=video_file.filename, emotions=emotions_detected,audio_path=path)
